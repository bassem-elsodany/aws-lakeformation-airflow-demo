...
with DAG(
    dag_id=DAG_ID,
    description="Run AWS Glue Mysql Workflow - source data to lakeformation-airflow-demo-raw data",
    ...
    run_glue_mysql_workflow = BashOperator(
        task_id="run_glue_mysql_workflow",
        bash_command="""aws glue start-workflow-run --name tickit_mysql_source_wf""",
    )    
